...
public class HzbInstance : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        posVisibleBuffer = new ComputeBuffer(count, 4 * 3);
    ...
    void culling()
    {
        ...
        {
            uint[] t = new uint[] { 0, 0, 0, 0, 0 };
            bufferWithArgs.GetData(t);
            ...
            Debug.Log("==========" + string.Concat(t[0],"  ", t[1], "  ", t[2], "  ", t[3], "  ", t[4]));
        }
